...
export function Footer() {
  return (
    <footer className="bg-[var(--foreground)] text-white/50 py-16 border-t border-white/10">
      <div className="container-width grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6">
          ...
          <p className="text-sm leading-relaxed">
            Bugaking Group is a diversified company driving progress across
            technology, real estate, and agriculture.
          </p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4">
            ...
            <Link
              ...
              target="_blank"
              className="size-10 rounded-lg bg-white/5 flex items-center justify-center hover:bg-primary hover:text-charcoal transition-all"
            >
              <svg
          ...
          <div className="pt-4 border-t border-white/5">
            ...
            <p className="text-xs mt-1">
              The Penthouse, Real Tower Plaza, Opposite Zenith Bank, Utako,
              Abuja.{" "}
            </p>
          </div>
        </div>
