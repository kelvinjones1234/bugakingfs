...
export default function AddUserModal({
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-[#171512]/60 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        {status === "success" ? (
          <div className="p-12 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-[#171512]/50 text-sm">User record updated.</p>
          </div>
        ) : (
          <>
            <div className="p-6 border-b border-[#171512]/5 flex items-center justify-between bg-[#f8f7f6]">
              <div>
                <h3 className="text-xl font-black font-serif text-[#171512]">
                  {initialData ? "Edit User" : "Add New User"}
                </h3>
              </div>
              <button onClick={onClose} className="text-[#171512]/30 hover:text-[#171512]">
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      required 
                      className="w-full pl-10 pr-4 py-3 bg-[#f8f7f6] rounded-xl text-sm font-bold focus:ring-2 focus:ring-[#d0a539]/20 outline-none" 
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <select 
                      className="w-full pl-10 pr-4 py-3 bg-[#f8f7f6] rounded-xl text-sm font-bold focus:ring-2 focus:ring-[#d0a539]/20 outline-none appearance-none"
                      value={formData.role}
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      type="password"
                      required={!initialData} // Required only when creating
                      className="w-full pl-10 pr-4 py-3 bg-[#f8f7f6] rounded-xl text-sm font-bold focus:ring-2 focus:ring-[#d0a539]/20 outline-none" 
              ...
              <div className="mt-8 flex justify-end gap-4">
                <button type="button" onClick={onClose} className="px-6 py-3 text-xs font-black uppercase tracking-widest text-[#171512]/40 hover:text-[#171512]">
                  Cancel
                </button>
                <button 
                  type="submit" 
                  disabled={status === 'submitting'}
                  className="bg-[#171512] text-white px-8 py-3 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-[#d0a539] hover:text-[#171512] transition-all flex items-center gap-2"
                >
